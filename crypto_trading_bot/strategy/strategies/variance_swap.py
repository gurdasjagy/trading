...
class VarianceSwapStrategy(BaseStrategy):
    """Short-term vs long-term realized variance mean reversion."""

    _STRATEGY_NAME = "variance_swap"
    ...
    def analyze(self, df: pd.DataFrame, symbol: str = "") -> Optional[Dict[str, Any]]:
        ...
        if r > 1.5:
            ...
            confidence = round(min(0.9, 0.5 + (r - 1.5) * 0.15), 3)
        else:
            return None
        ...
        return {
            ...
            "reasoning": f"Variance ratio rv5/rv20={r:.2f}, mean-revert",
        }
